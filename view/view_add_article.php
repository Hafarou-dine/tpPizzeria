        ...
        <div class="m-5">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="container shadow p-5 mb-5 bg-body rounded">
                    <p>Titre de l'article :<input type="text" name="titre_art" class="form-control" required></p>
                    <p>Contenu de l'article :<textarea name="contenu_art" class="form-control" cols="50" rows="10" required></textarea></p>
